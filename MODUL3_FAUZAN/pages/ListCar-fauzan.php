...
<head>
    ...
    <title>List Car | Fauzan_1202204056</title>
        ...
        <div class="container">
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            <div class='card-body'>
              ...
              <span class='d-flex'>
                <a href='Detail-fauzan.php?id=" . $row["id_mobil"] . "' class='btn btn-primary' style='border-radius: 100px; width:140px; height: 36px;'>Detail</a>
