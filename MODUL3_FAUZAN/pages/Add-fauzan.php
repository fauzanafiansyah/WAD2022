        ...
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav gap-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" style="font-weight: bold; color:white;" href="Add-fauzan.php">Mycar</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <form action="../config/insert.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    ...
                    <input name="nama" type="text" class="form-control" id="nama" aria-describedby="nama" placeholder="Masukkan Nama Mobil anda">
                </div>
                <div class="mb-3">
                    <label for="pemilik" class="form-label"><b>Nama Pemilik</b></label>
                    <input name="pemilik" type="text" class="form-control" id="pemilik" aria-describedby="pemilik" placeholder="Masukkan Nama Pemilik Mobil">
                </div>
                <div class="mb-3">
                    <label for="merk" class="form-label"><b>Merk</b></label>
                    <input name="merk" type="text" class="form-control" id="Merk" aria-describedby="Merk" placeholder="Masukkan Merk Mobil Anda">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3" style="display: block;">
                    ...
                    <textarea name="desc" id="deskripsi" name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi Mobil Anda"
                ...
                <div class="mt-3">
                    ...
                    <input type="file" class="form-control" id="foto" name='gambar' accept="image/* " style="height: 37px;">
                </div>
                ...
                <div class="mt-3 d-flex" style="color: #757575; font-size: 15px;">
                    <input name="status" class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" style="width: 17px; height: 17px;">
                    <label class="form-check-label" for="inlineRadio1" style="margin-left: 10px;">Lunas</label>
                    <input name="status" class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2" style="width: 17px; height: 17px; margin-left: 20px">
